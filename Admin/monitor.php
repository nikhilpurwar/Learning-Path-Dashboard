...
// Add your instructor verification logic here

// 1. Student Registration Over Time
    ...
    <div class="dashboard-layout">
        ...
        <main class="dashboard-main">
            ...
            <div id="overview" class="section-container">
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="value"><?php echo count($registration_data); ?></div>
                        <div class="change">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="value">
                            <?php 
                                $avg_completion = array_sum(array_column($completion_data, 'avg_progress')) / count($completion_data);
                    ...
                    <div class="stat-card">
                        ...
                        <div class="value">
                            <?php 
                                $avg_rating = array_sum(array_column($price_rating_data, 'rating')) / count($price_rating_data);
            ...
            <div id="student-growth" class="chart-container section-container">
                ...
                <canvas id="studentGrowthChart" height="150"></canvas>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($completion_data as $course): ?>
                            <tr>
                                ...
                                <td>
                                    <?php 
                                        $completion_rate = ($course['completed'] / $course['total_enrollments']) * 100;
            ...
            <div id="price-analysis" class="chart-container section-container">
                ...
                <canvas id="priceRatingChart" height="160"></canvas>
            </div>
            ...
            <div id="student-activity" class="chart-container section-container">
                ...
                <canvas id="activityHeatmap" height="150"></canvas>
            </div>
        </main>
    </div>
                    ...
                    tooltip: {
                        callbacks: {
                            title: function(context) {
                                return $popular_courses[context[0].dataIndex].title;
                            }
                        }
                    }
                },
                    ...
                    tooltip: {
                        callbacks: {
                            label: function(context) {
                                const course = $price_rating_data[context.dataIndex];
                                return [
                                    course.title,
                                    'Price: $' + course.price,
